...
GO
PRINT N'Altering Procedure [dbo].[Get_AllFiles]...';


GO
ALTER PROCEDURE [dbo].[Get_AllFiles]
...
RETURN 0
GO
PRINT N'Altering Procedure [dbo].[Get_FileByDocumentType]...';


GO
ALTER PROCEDURE [dbo].[Get_FileByDocumentType]
	
AS
	SELECT F.WholeCaseNumber, F.Name, D.DocumentName FROM File_TB F
	JOIN DocumentType_TB D ON F.DocumentId = D.DocumentName;
